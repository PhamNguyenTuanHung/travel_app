...
async function main() {
  ...
  await prisma.$executeRawUnsafe(`
    ...
    (11, 5, 3, 'Chợ đêm Phú Quốc', 'Phu Quoc Night Market',
     'Thiên đường ẩm sực hải sản và mua sắm về đêm tại đảo ngọc.', 'A paradise of seafood street food and night shopping on Pearl Island.',
    ...
    (15, 2, 4, 'Đặc sản Tung Lò Mò Châu Phong', 'Chau Phong Tung Lo Mo',
     ...
     'Châu Phong, Tân Châu, An Giang', 'Chau Phong, Tan Châu, An Giang',
